...
public class MeanCheck extends MidlGrammarBaseVisitor<String> {
     ...
     */
    @Override
    public String visitFloating_pt_type(MidlGrammarParser.Floating_pt_typeContext ctx) {
    ...
    public String visitArray_declarator(MidlGrammarParser.@NotNull Array_declaratorContext ctx) {
        ...
        if(res==null){
            ...
            else er.addError(ctx.getStart().getLine()+":"+ctx.getStart().getCharPositionInLine(),"Array",arrayLength,typeError,null);
